...
export default function Pomorodo() {
    ...
    const modeLabel =
        mode === 'work' ? 'Focus' : breakKind === 'long' ? 'Long break' : 'Break'
    const modeHint =
        ...
        <Card className="w-full p-4">
            ...
            <div className="flex items-center justify-between gap-3">
                <div className="space-y-1">
                    ...
                    <p className="text-xs text-muted-foreground">Session {Math.min(4, workSessionsCompleted + 1)} / 4</p>
                </div>
